...
create_generated_clock -name {SimpleVGA|ClockVGA_derived_clock} -source [get_pins ClockVGA_LC_0/clk] [get_pins ClockVGA_LC_0/lcout] -add -master_clock [get_clocks SimpleVGA|Clock12MHz]
